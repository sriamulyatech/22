...
const StudentRegistration: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const isMobileValid = validateIndianMobile(formData.mobile);
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    // Auto-formatting/validation for mobile while typing
    if (name === 'mobile') {
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <User size={16} className="text-gold" aria-hidden="true" /> Full Name
                      </label>
                      <input
                        type="text"
                        name="fullName"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <Mail size={16} className="text-gold" aria-hidden="true" /> Email Address
                      </label>
                      <input
                        type="email"
                        name="email"
                        ...
                        onChange={handleChange}
                        autocomplete="email"
                        className={`w-full bg-gray-50 border ${emailError ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gold transition-all`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <Phone size={16} className="text-gold" aria-hidden="true" /> Mobile Number
                      </label>
                      <input
                        type="tel"
                        name="mobile"
                        ...
                        autocomplete="tel"
                        pattern="[6-9]{1}[0-9]{9}"
                        className={`w-full bg-gray-50 border ${mobileError ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gold transition-all`}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <Calendar size={16} className="text-gold" aria-hidden="true" /> Date of Birth
                      </label>
                      <input
                        type="date"
                        name="dob"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <GraduationCap size={16} className="text-gold" aria-hidden="true" /> Qualification
                      </label>
                      <select
                        name="qualification"
                        required
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                        <BookOpen size={16} className="text-gold" aria-hidden="true" /> Interested Course
                      </label>
                      <select
                        name="course"
                        required
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-[#001f3f] flex items-center gap-2">
                      <MapPin size={16} className="text-gold" aria-hidden="true" /> Residential Address
                    </label>
                    <textarea
                      name="address"
                      required
